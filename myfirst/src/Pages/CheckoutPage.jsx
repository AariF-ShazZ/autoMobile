...
export const CheckoutPage = () => {
  ...
  // console.log("checkout  page",usersData);
  ...
  // let userDetails = usersData.find((item) => item._id === cart[0].userID)
    ...
    <Box>
      ...
      <Stack p="10" gap={"20PX"} direction={{ base: "column", lg: "row" }}>
        ...
        <Box id="paymentBox">
          ...
          <Box p="15px" mt="20px">
            <RadioGroup onChange={setPaymentmethod} value={paymentmethod}>
              ...
              <Box>
                <Flex>
                  <FcLock fontSize={"22px"} />{" "}
                  <Text fontWeight={"bold"}> Secure credit card payment</Text>
                </Flex>
                <Text>This is a secure TLS 1.2 SSL encrypted payment.</Text>
              </Box>
              <Flex fontWeight={"bold"}>
                <Radio value="creditcard" mr="5px">
                  Credit Card
                </Radio>
                <Spacer />
                <Flex gap="5" color={"#e53e3e"} fontSize={"30px"} mr="40px">
                  <FaCcVisa />
                  <FaCcMastercard />
                  <FaCcAmex />
                  <FaCcDiscover />
        ...
        <Box id="orderSummaryBox" mw={"385px"}>
          <Box pb="10px">
            <Heading as="h4">3. Confirmation</Heading>
          </Box>
          <Box p="15px">
            ...
            <Box textAlign={"center"}>
              ...
              <Modal isCentered isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                  ...
                  <ModalFooter>
                    <Button color={"white"} bg="#e53e3e" onClick={RedirectToHome}>
